...
| T124 live-calibrated macro coherence | PASSED | Measured 10-descriptor live-strength fixture retains one substantial lower base, role hierarchy, bounded protrusions, no macro fingers, low-frequency dominance, and a stable macro silhouette when detail-B is neutralized |
| T125 live-calibrated role-envelope transitions | PASSED | CORE→TOWER and TOWER→ANVIL overlap and connected cross-sections are retained; canopy/tower is 6.0991, upper/base lateral coverage is 1.8372, and the narrowest transition is 0.9708 of its lower transition radius |
| T134 severe-system physical scale (`cloudMorphologyTopologySandbox`) | PASSED | 128 seeded production source plans hold the ten-member contract (`planRadius=450.0`, `groupRadius=400.0`, `baseDrop=120.0`, `topRise=780.0`), a 1,200–1,500 horizontal envelope at both stable-scale/jitter endpoints, a 720–880 height, and every T127 role subrange: BASE 900–1100, CORE 420–520, lower TOWER 280–360, upper TOWER 180–250, ANVIL thickness 150–220. Emits `T134_SCALE_CONTRACT|members=10|planRadius=450.0|groupRadius=400.0|baseDrop=120.0|topRise=780.0|footprint=1200..1500|height=720..880` and `T134_RESOLVED_CENTRE_ENVELOPE|matureLowerMin=1265.701|matureUpperMax=1416.327` |
| T126 live `3c039aa7` structural continuity | PASSED | Vertical radius/area derivatives are 0.0903/0.1724; CORE→TOWER embedded overlap is 104/59 blocks, TOWER→ANVIL overlap is 92/26.25 blocks, canopy/tower is 6.1330/5.6159, low-frequency underside SD is 9.1334/8.5227, and the warped low-frequency aspect (1.7500) remains below unwarped (1.9200) |
