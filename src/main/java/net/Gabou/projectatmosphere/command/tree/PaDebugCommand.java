        ...
        return Commands.literal("debug")
                ...
                .then(Commands.literal("cyclone")
                        ...
                        .then(Commands.literal("candidates")
                                .executes(ctx -> CommandDebugService.runCycloneCandidates(ctx.getSource())))
                ...
                .then(Commands.literal("lows")
                        .executes(ctx -> CommandDebugService.runWeakLows(ctx.getSource()))
                        .then(Commands.literal("active")
                                .executes(ctx -> CommandDebugService.runWeakLows(ctx.getSource())))
                        .then(Commands.literal("candidates")
                                .executes(ctx -> CommandDebugService.runWeakLowCandidates(ctx.getSource()))))
                .then(Commands.literal("weathercells")
                        .executes(ctx -> CommandDebugService.runWeatherCellCandidates(ctx.getSource()))
                        .then(Commands.literal("candidates")
                                .executes(ctx -> CommandDebugService.runWeatherCellCandidates(ctx.getSource()))))
                .then(Commands.literal("stormbridge")
                        .executes(ctx -> CommandDebugService.runStormBridge(ctx.getSource())))
                .then(Commands.literal("condensation")
                        .executes(ctx -> CommandDebugService.runCondensation(ctx.getSource())))
