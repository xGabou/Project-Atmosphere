...
public final class CloudFieldTargetResolver {
    ...
    private CloudFieldTarget missingSourceTarget(CloudField currentField, CloudFieldSource source, int missingSourceTicks) {
        ...
        return new CloudFieldTarget(
                ...
                currentField.cloudTypeId(),
                currentField.morphologyFamily(),
                currentField.anvilStrength(),
    ...
    private static CloudFieldTarget stabilizeTarget(CloudField currentField, CloudFieldTarget target) {
        return new CloudFieldTarget(
                ...
                target.cloudTypeId(),
                target.morphologyFamily(),
                holdSmallDelta(currentField.anvilStrength(), target.anvilStrength(), SCALAR_EPSILON),
                holdSmallDelta(currentField.precipitationIntensity(), target.precipitationIntensity(), SCALAR_EPSILON),
