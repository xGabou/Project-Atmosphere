...
public final class CustomPrecipitationRenderer {
    ...
    private static void addColumnQuad(
        ...
        buffer.vertex(topX - quadX, (double) maxY - camY, topZ - quadZ).uv(uOffset, vMin).color(1.0F, 1.0F, 1.0F, alpha).uv2(light).endVertex();
        buffer.vertex(topX + quadX, (double) maxY - camY, topZ + quadZ).uv(1.0F + uOffset, vMin).color(1.0F, 1.0F, 1.0F, alpha).uv2(light).endVertex();
        buffer.vertex(baseX + quadX, (double) minY - camY, baseZ + quadZ).uv(1.0F + uOffset, vMax).color(1.0F, 1.0F, 1.0F, alpha).uv2(light).endVertex();
        buffer.vertex(baseX - quadX, (double) minY - camY, baseZ - quadZ).uv(uOffset, vMax).color(1.0F, 1.0F, 1.0F, alpha).uv2(light).endVertex();
    }
}
