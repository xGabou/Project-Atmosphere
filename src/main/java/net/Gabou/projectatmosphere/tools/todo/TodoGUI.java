...
public class TodoGUI extends JFrame {
    ...
    public TodoGUI() {
        setTitle("Project Atmosphere â€“ Interactive TODO");
        ...
        for (Section section : sections) {
            JLabel sectionLabel = new JLabel("ðŸ“Œ " + section.title);
    ...
    private void saveToMarkdown() {
        ...
        if (chooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try (FileWriter writer = new FileWriter(chooser.getSelectedFile())) {
                ...
                JOptionPane.showMessageDialog(this, "âœ… Markdown and progress saved!");
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(this, "âŒ Error: " + ex.getMessage());
            }
        }
    }
