...
public final class StormShieldManager {
    ...
    private static Block getStormShieldBlock() {
        // NeoForge DeferredHolder preserves Forge RegistryObject-style lazy lookup after registration.
        // Chunk and block events fire after the block registry is frozen, so resolving here matches the old runtime lookup.
        return ModBlocks.STORM_SHIELD.get();
    }
