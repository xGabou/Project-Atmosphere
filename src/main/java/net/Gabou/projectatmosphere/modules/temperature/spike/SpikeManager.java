...
public class SpikeManager {
    ...
    private static final Map<ForecastRegionId, SpikeState> regionSpikeStates = new HashMap<>();

    public static float[][] applySpikeLogic(ForecastRegionId regionId, float[][] week) {
    ...
    public static Map<ForecastRegionId, SpikeState> getAllStates() {
        return regionSpikeStates;
    }

    public static void setAllStates(Map<ForecastRegionId, SpikeState> map) {
