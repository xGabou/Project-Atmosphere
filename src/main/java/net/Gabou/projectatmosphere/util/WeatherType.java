...
public enum WeatherType {
    ...
    static {
        ...
        CLOUD_MAP.put(new ResourceLocation("simpleclouds", "floating_farlands"), NONE);
        ...
        CLOUD_MAP.put(new ResourceLocation("simpleclouds", "overcast"), NONE);
        ...
        CLOUD_MAP.put(new ResourceLocation("simpleclouds", "thicker_stratocumulus"), NONE);
